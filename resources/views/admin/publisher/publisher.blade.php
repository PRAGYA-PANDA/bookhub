                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @if ($publisher['status'] == 1)
                                                        <a class="updatePublisherStatus" id="publisher-{{ $publisher['id'] }}" publisher_id="{{ $publisher['id'] }}" href="javascript:void(0)"> {{-- Using HTML Custom Attributes. Check admin/js/custom.js --}}
