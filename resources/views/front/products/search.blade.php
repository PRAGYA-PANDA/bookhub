                ...
                <div class="card-body">
                    ...
                    <form action="{{ url('/search-products') }}" method="get" id="filterForm">
                        ...
                        <div class="mb-4">
                            ...
                            <button type="submit" class="btn btn-sm btn-primary w-100 mt-2" style="background-color: #6c5dd4; border-color: #6c5dd4;">
                                Apply Price Filter
                            </button>
                        </div>

                        <!-- Clear All Filters -->
                        @if(request('search') || request('section_id') || request('condition') || request('min_price') || request('max_price'))
