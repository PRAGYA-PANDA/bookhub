...
class Product extends Model
{
    ...
    public function publisher() { // Every product belongs to some publisher    // this relationship method is used in Front/ProductsController.php
        return $this->belongsTo('App\Models\Publisher', 'publisher_id'); // 'publisher_id' is the foreign key
    }
